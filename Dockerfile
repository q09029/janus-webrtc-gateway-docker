...
RUN apt-get -y update && apt-get install -y v4l-utils
RUN apt-get -y update && apt-get install -y gstreamer1.0-omx gstreamer1.0-tools gstreamer1.0-plugins-good gstreamer1.0-plugins-bad
